...
const SecondPage = () => (
  <Layout>
    ...
    <p>Send us an email to oweek.communications@mcgilleus.ca any time, or come see us at the registration tent after August 21st.</p>
    ...
    <p>This answer varies by event, so check out the Events page for event-specific details. Here are some items you should carry with you:
    &bull; Water<br></br>
    ...
    <p>Any concerns can be sent to oweek.communications@mcgilleus.ca, and the appropriate Coordinator will reply to your question.</p>
